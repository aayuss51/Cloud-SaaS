...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "group relative inline-flex items-center justify-center rounded-2xl font-bold transition-all duration-500 focus:outline-none focus:ring-4 focus:ring-emerald-500/10 active:scale-[0.97] backdrop-blur-xl overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100";
  
  const variants = {
    primary: `
      bg-emerald-600/90 text-white 
      hover:bg-emerald-500/95 
      border-t border-white/25 border-b border-emerald-900/20
      shadow-[0_10px_30px_-10px_rgba(16,185,129,0.5)] hover:shadow-[0_15px_40px_-10px_rgba(16,185,129,0.7)]
      ring-1 ring-white/10
    `,
    liquid: `
      bg-gradient-to-br from-emerald-600 via-emerald-500 to-green-600 text-white
      border-t border-white/40 border-b border-black/20
      shadow-[0_20px_50px_-15px_rgba(16,185,129,0.5)]
      hover:shadow-[0_30px_60px_-15px_rgba(16,185,129,0.7)]
